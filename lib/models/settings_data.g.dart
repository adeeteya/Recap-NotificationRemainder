...
extension SettingsDataQueryFilter
  ...
  QueryBuilder<SettingsData, SettingsData, QAfterFilterCondition>
      showInitialHintEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'showInitialHint',
        value: value,
      ));
    });
  }
...
extension SettingsDataQuerySortBy
  ...
  QueryBuilder<SettingsData, SettingsData, QAfterSortBy>
      sortByShowInitialHint() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showInitialHint', Sort.asc);
    });
  }

  QueryBuilder<SettingsData, SettingsData, QAfterSortBy>
      sortByShowInitialHintDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'showInitialHint', Sort.desc);
    });
  }
}
...
extension SettingsDataQueryWhereDistinct
  ...
  QueryBuilder<SettingsData, SettingsData, QDistinct>
      distinctByShowInitialHint() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'showInitialHint');
    });
  }
}
...
extension SettingsDataQueryProperty
  ...
  QueryBuilder<SettingsData, bool, QQueryOperations> showInitialHintProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'showInitialHint');
    });
  }
}
